...
void bsp_mcu_uart6_init(                const   size_t          baud )
{
	...
	HAL_NVIC_SetPriority(   DMA2_Stream6_IRQn,      BSP_NVIC_PRIO_GNSS_DMA_TX, 0 ); //DMA TX
	HAL_NVIC_EnableIRQ(     DMA2_Stream6_IRQn );

	HAL_NVIC_SetPriority(   DMA2_Stream1_IRQn,      BSP_NVIC_PRIO_GNSS_DMA_RX, 0 ); //DMA RX
	HAL_NVIC_EnableIRQ(     DMA2_Stream1_IRQn );

	HAL_NVIC_SetPriority(   USART6_IRQn,            BSP_NVIC_PRIO_GNSS_RECV_SMBL, 0 );
